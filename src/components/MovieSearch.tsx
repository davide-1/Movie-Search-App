...
// import { useForm } from "react-hook-form"; // Form management and validation
...
// // Props from parent — sends query up to HomePage
...
//     reset,
//     formState: { errors },
//   } = useForm<FormValues>(); // Initialize the form with validation tracking

//   const onSubmit = (data: FormValues) => {
//     onSearch(data.query); // Call parent handler with search string
//     reset(); // Clear the input after search
//   };
